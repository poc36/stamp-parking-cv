...
### 🖥️ Интерактивный Web GUI

![Web GUI - Multi-Camera View](results/gui_screenshot_1.png)
*Интерактивный дашборд: агрегированный вид с 4 камер, цветовая кодировка, зоны видимости камер (Тест 1 - 55% занятости).*

![Web GUI - High Occupancy](results/gui_screenshot_2.png)
*Сценарий Тест 3 (90% занятости) с детальной информацией по каждому месту: процент уверенности детектирования (согласно ТЗ) и статус (занято/свободно).*
